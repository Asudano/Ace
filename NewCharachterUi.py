...
class NewCharacterUi(Frame):
    ...
    Attributes:
        char_attribute : a list<str> that contains the entry objects to be
         referency when creating a new character.
        game_data : the GameData singleton
        user_logs : the UserLogs singleton
        """
    def __init__(self, game_data, user_logs, index=0, master=None):
    ...
    def create_widgets(self):
        ...
        level_up_character.grid(row=11,
                                ...
                                columnspan=2,
                                sticky=E + W)
        self.components.append(level_up_character)
...
if __name__ == "__main__":
	...
	app = NewCharacterUi(game_data, user_logs,0, master=root)
	app.mainloop()
	root.destroy()
